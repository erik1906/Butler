...
public interface MapsInterface {
    ...
    @GET("json?")
    Call<DirectionRes> getDirectionPlace (@Query("origin") String origin, @Query("destination") String destination,@Query("waypoint") String waypoint ,@Query("key") String key );
